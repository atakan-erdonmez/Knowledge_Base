...
## Resource Policy
API Gateway supports resource policies, which are [[00_KnowledgeBase/AWS CSA/IAM/IAM]]-style JSON policies that you attach directly to your REST or HTTP APIs. These policies can use IpAddress and NotIpAddress conditions to enforce fine-grained network controls. 
