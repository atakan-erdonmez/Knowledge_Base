...
- You can use other AWS resources such as Amazon [[EBS (Elastic Block Store)]], [[RDS]], [[00_KnowledgeBase/AWS CSA/EC2/Elastic Load Balancer (ELB)/Elastic Load Balancer (ELB)|Elastic Load Balancer (ELB)]], [[Auto Scaling Groups (ASG)]], [[Lambda]], [[SQS]], [[DynamoDB]], [[S3]] bucket, [[ECS (Elastic Container Service)]], [[EKS]], [[SNS]], [[API Gateway]]…
