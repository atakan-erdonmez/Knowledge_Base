...
#### Throughput Mode
- **Bursting** - 1 TB = 50MiB/s + burst of up to 1000MiB/s (throughput relies on the amount of data stored). You accumulate credit with time, and you can spend that credit when burst happens.
- **Provisioned** - set your throughput regardless of storage size (gives consistent throughput regardless of the amount of data stored). It is great for multiple simultaneous writes
...
- Does not automatically enable burst throughput