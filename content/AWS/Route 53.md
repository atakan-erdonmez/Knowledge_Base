...
tag:
  ...
  - "[[00_KnowledgeBase/OLD-2- Tags/DNS|DNS]]"
---
...
- **Private hosted zones** only route within one or more [[VPC]]
	- For private hosted zones, you need to enable *enableDnsSupport* and *enableDnsHostnames* attributes on the VPC.
